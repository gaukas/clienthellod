...
var headerTestMap = map[string]struct {
	...
	"quic_IETF_DATA_MozillaFirefox": {
		data:  quicIETFData_MozillaFirefox,
		truth: quicHeaderTruth_MozillaFirefox,
	},
}
...
var (
	...
	quicIETFData_MozillaFirefox = []byte{
		,
	...
	quicHeaderTruth_MozillaFirefox = &QUICHeader{
		Version:      []byte{0x00, 0x00, 0x00, 0x01},
		DCIDLength:   13,
		SCIDLength:   3,
